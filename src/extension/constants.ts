...
export const GITLAB_CLI_DESC= 'gitlab-cli-desc';
export const DOMAIN_NAME= 'gitlab.com';
export const PROJECT_ID= 36539523;
export const PRIVATE_TOKEN = 'glpat-9sBQ-UPDLWDUBxiqZmHY';